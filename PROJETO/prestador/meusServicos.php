                        ...
                        <div class="card shadow-sm h-100">
                            ...
                            <div class="card-body d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <p class="text-muted mb-1 small"><strong>Categoria:</strong> <?= $row['categoria'] ?? 'Não informada' ?></p>
                                    <p class="text-muted mb-1 small"><strong>Região:</strong> <?= $row['local_servico'] ?? 'Não informada' ?></p>
                                    <?php
