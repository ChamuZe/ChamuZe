        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            <form action="" method="get" class="filtro">
                <select name="categoria">
                    ...
                    <option value="construcao" <?= $categoriaSelecionada == "construcao" ? "selected" : "" ?>>Construção
                    </option>
                    <option value="encanamento" <?= $categoriaSelecionada == "encanamento" ? "selected" : "" ?>>Encanamento
                    </option>
                    <option value="jardinagem" <?= $categoriaSelecionada == "jardinagem" ? "selected" : "" ?>>Jardinagem
                    </option>
                </select>
